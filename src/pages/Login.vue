    ...
    <div>
        <div class="">
            ...
            <div class="flex justify-center  ">
                <div class=" mt-24 max-w-md  p-3 shadow-2xl">

                    <div class="text-center m-6">
                        <h1 class="text-3xl font-semibold">S'INSCRIRE</h1>
                        <p class="font-thin text-sm">Créer votre compte, afin de pouvoir
                            réaliser
                            toutes vos
                    ...
                    <div class=" m-6">
                        <form class="mb-4">
                            ...
                            <div class="mb-6">
                                <button type="button" class="w-full px-3 py-4 text-noirfond bg-blanctext ">SE
                                    CONNECTER</button>
                            </div>
